...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/admin/static/h-ui.admin/skin/red/skin.css" id="skin" />
...
<section class="Hui-article-box">
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
            ...
            <iframe id="iframe-welcome" data-scrolltop="0" scrolling="yes" frameborder="0" src="/admin/welcome"></iframe>
        </div>
    </div>
</section>
